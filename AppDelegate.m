...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UINavigationController *navControllerFive=[[tabBarController viewControllers]objectAtIndex:4];
    ...
    LocationTableViewController *ltvc=[[navControllerTwo viewControllers]objectAtIndex:0];
   ...
   uvc.managedObjectContext=self.managedObjectContext;
    ...
    //PackageTableViewController (index 4)
    PackageListViewController *plvc=[[navControllerFive viewControllers]objectAtIndex:0];
    plvc.managedObjectContext=self.managedObjectContext;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"RelationalCD" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"RelationalCD.sqlite"];
